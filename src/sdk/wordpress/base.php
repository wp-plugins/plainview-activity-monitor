	...
	extends \plainview\sdk_pvam\base
{
	...
	**/
	...
	/**
		...
		@param		array		$inputs		Array of \\plainview\\sdk_pvam\\wordpress\\form inputs.
		@param		array		$options	Array of options.
		@since		20130416
	**/
	public function display_form_table( $inputs, $options = array() )
	{
		$options = \plainview\sdk_pvam\base::merge_objects( array(
			'form' => null,
			'header' => '',
			'header_level' => 'h3',
		), $options );
...
**/
	...
	**/
	...
	/**
		...
		@return		object					A new \\plainview\\sdk_pvam\\wordpress\\form object.
		@since		20130416
	**/
	public function form( $options = array())
	{
		...
		return new \plainview\sdk_pvam\wordpress\form( $options );
	}
	...
	**/
	public function tabs( $options = array() )
	{
		if ( count( $options ) == 0 )
		{
			$tabs = new \plainview\sdk_pvam\wordpress\tabs\tabs( $this );
			return $tabs;
		}
